...
def _provider_factory(provider: ProviderName, client) -> OpenAIProvider | AnthropicProvider:
    if provider == "openai":
...
async def chat(
    provider: ProviderName = Path(..., description="LLM provider: openai | anthropic"),
